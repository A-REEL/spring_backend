...
public class Person extends Generics {
    ...
    // Add a method to check authentication
    public boolean authenticate(String username, String password) {
        return this.uid.equals(username) && this.password.equals(password);
    }
    ...
    public static void main(String[] args) {
        ...
        String username = "toby@gmail.com";
        String password = "123Toby!";
